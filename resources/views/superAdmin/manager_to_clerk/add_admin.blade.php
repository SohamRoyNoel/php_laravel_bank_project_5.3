...
@section('content')
    <div class="panel-body">
        <center><h2>Admin Registration by Super Admin</h2></center>
        <div class="clearfix"> </div>

        {!! Form::open(['method'=>'POST', 'action'=>'manager_adds_admin@store', 'files'=>true, 'class'=>'form-horizontal']) !!}
        ...
        <div class="form-group has-error">
            ...
            <div class="col-md-8">
                <div class="input-group input-icon right">
                    ...
                    {!! Form::text('one_time_pasword', null, ['class'=>'form-control1', 'placeholder'=>'Admin\'s password']) !!}
                </div>
            </div>
        </div>
